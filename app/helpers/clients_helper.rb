module ClientsHelper
  ...
  def info_tab(i)
    if i == 0
      "Те клиенты, которые в данный момент пользуются услугами в вашем филиале"
    elsif i == 1
      "Все клиенты компании имеющие долг, также те, кто в архиве"
    elsif i == 2
      "Все клиенты компании, включая архив"
    elsif i == 3
      "Архив"
    else
      "Без названия"
