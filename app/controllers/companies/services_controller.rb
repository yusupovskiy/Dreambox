class Companies::ServicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @service.save
        format.html { redirect_to [@service.company, @service], notice: 'Service was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @service.update(service_params)
        format.html { redirect_to [@service.company, @service], notice: 'Service was successfully updated.' }
  ...
  def destroy
    @service.destroy
    respond_to do |format|
      format.html { redirect_to company_services_url, notice: 'Service was successfully destroyed.' }
